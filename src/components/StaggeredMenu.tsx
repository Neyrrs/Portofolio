        ...
        >
          ...
          >
            ...
            >
              <span
                ref={textInnerRef}
                className={`sm-toggle-textInner ${open ? 'text-black' : 'text-white'} font-bold flex flex-col leading-none`}
              >
                {textLines.map((l, i) => (
                  <span
            ...
            <span
              ref={iconRef}
              className={`sm-icon ${open ? 'text-black' : 'text-white'} relative w-[14px] h-[14px] shrink-0 inline-flex items-center justify-center [will-change:transform]"
              aria-hidden="true`}
            >
              <span
                ref={plusHRef}
        ...
        >
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              ...
              >
                <h3 className="sm-socials-title m-0 text-base font-medium text-primary">
                  Socials
                </h3>
                <ul
